...
import { homeOutline, pawOutline, pencilOutline, qrCodeOutline, bookOutline } from 'ionicons/icons';
...
export class FooterComponent {
  ...
  constructor() { 
    addIcons({homeOutline,pawOutline,bookOutline,pencilOutline,qrCodeOutline});
  }
